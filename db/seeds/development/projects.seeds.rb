  ...
  [
    { title: 'Only Black and White',
      ...
      technologies: [
        ...
        Technology.find_by(name: 'Haskell'),
        Technology.find_by(name: 'HTML'),
        Technology.find_by(name: 'WebSockets'),
        Technology.find_by(name: 'MongoDB'),
        Technology.find_by(name: 'Ruby on Rails'),
        Technology.find_by(name: 'Node.js'),
        Technology.find_by(name: 'OCaml'),
        Technology.find_by(name: 'Markdown')],
      third_parties: [
        ThirdParty.find_by(name: 'PT Sans'),
        ThirdParty.find_by(name: 'PT Serif'),
        ThirdParty.find_by(name: 'Backbone.js'),
        ThirdParty.find_by(name: 'Pry'),
        ThirdParty.find_by(name: 'Ray'),
        ThirdParty.find_by(name: 'Draper'),
        ThirdParty.find_by(name: 'RSpec'),
        ThirdParty.find_by(name: 'Fancy images pack'),
        ThirdParty.find_by(name: 'Factory Girl'),
